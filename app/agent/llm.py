...
result = llm.invoke(prompt.format(pickups_str="""
🏫 [8] Scholars (no Eighth)
(2) seventh: carly, irene
(1) marshall (pangea): kristi
(1) erc: clement
...
""", drivers_str="Brenton has capacity 4, DLC has capacity 4, Rory has capacity 1, Luke has capacity 3, Joelle has capacity 4"))
