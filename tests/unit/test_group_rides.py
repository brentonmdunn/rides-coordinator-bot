...
class TestParseNumbers:
    ...
    def test_mixed_spaces(self) -> None:
...
class TestLlmInputDrivers:
    ...
    def test_list_with_different_data_types(self) -> None:
...
class TestFindPassenger:
    ...
    def test_find_passenger_at_wrong_location(self, sample_locations_people: PassengersByLocation) -> None:
    ...
    def test_find_passenger_nonexistent_person(self, sample_locations_people: PassengersByLocation) -> None:
    ...
    def test_find_passenger_with_empty_data(self) -> None:
...
class TestCountTuples:
    ...
    def test_count_with_multiple_items(self, sample_locations_people: PassengersByLocation) -> None:
    ...
    def test_count_with_some_empty_lists(self, sample_passengers: dict[str, Passenger]) -> None:
    ...
    def test_count_with_empty_dict(self) -> None:
...
class TestIsEnoughCapacity:
    ...
    def test_capacity_is_enough(self, sample_locations_people: PassengersByLocation) -> None:
    ...
    def test_capacity_is_exact(self, sample_locations_people: PassengersByLocation) -> None:
    ...
    def test_capacity_is_not_enough(self, sample_locations_people: PassengersByLocation) -> None:
    ...
    def test_no_drivers(self, sample_locations_people: PassengersByLocation) -> None:
...
class TestCalculatePickupTime:
    ...
    def test_simple_calculation(self, mock_lookup_time) -> None:
...
class TestLlmInputPickups:
    ...
    def test_multiple_locations_and_passengers(self, sample_locations_people: PassengersByLocation) -> None:
    ...
    def test_location_with_empty_passenger_list(self, sample_passengers: dict[str, Passenger]) -> None:
