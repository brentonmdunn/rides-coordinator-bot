...
| Pickup info write (`PickupInfoService` — website or Discord registration) | `invalidate_namespace()` | `ASK_RIDES_REACTIONS` + `ASK_DRIVERS_REACTIONS` | Next read re-fetches |
