...
class UserPreferencesRepository:
    ...
    @staticmethod
    async def get_by_email(session: AsyncSession, email: str) -> UserPreferences | None:
        """
    ...
    @staticmethod
    async def get_or_create(session: AsyncSession, email: str) -> UserPreferences:
        """
    ...
    async def update_preferences(
        ...
        """
        if not kwargs:
            return await UserPreferencesRepository.get_by_email(session, email)
